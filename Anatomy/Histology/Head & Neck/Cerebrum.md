...
```mermaid
flowchart TD
    C[Cerebral Architecture] --> GM[Outer Gray Matter / Cortex]
    C --> WM[Inner White Matter]

    GM --> L1[I. Molecular / Plexiform Layer]
    GM --> L2[II. External Granular Layer]
    GM --> L3[III. External Pyramidal Layer]
    GM --> L4[IV. Internal Granular Layer]
    GM --> L5[V. Internal Pyramidal / Ganglionic Layer]
    GM --> L6[VI. Multiform / Polymorphic Layer]

    WM --> WMC[Myelinated Fibers + Neuroglial Cells]
