...
```mermaid
flowchart TD
    A["Deficiency of myenteric plexus at LES"] --> B["↓ VIP + NO"]
    B --> C["↓ Inhibitory relaxation of LES"]
    C --> D["↑ Resting LES tone"]
    D --> E["Failure of LES relaxation during swallowing"]
    E --> F["Impaired esophageal emptying"]
    F --> G["Food + fluid accumulate in esophagus"]
    G --> H["Progressive dilatation of esophagus"]
```
