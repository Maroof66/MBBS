...
```mermaid
flowchart TD
    PL["Phospholipids"] -->|"Phospholipase A"| LPL["Lysophospholipids"]
    LPL -->|"Phospholipase B"| EndP["Phosphorylcholine + Free Fatty Acids (FFA)"]
...
> ![alt text](images/enzymesofpancreas.png)
